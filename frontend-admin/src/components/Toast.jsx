...
const Toast = ({
  ...
  return (
    <div className="fixed top-4 right-4 z-[10001] animate-in slide-in-from-top duration-300">
      <div
        className={`${getToastColor()} text-white px-4 py-3 rounded-lg shadow-lg flex items-center space-x-3 max-w-sm`}
      >
